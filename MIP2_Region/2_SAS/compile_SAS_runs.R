...
in.base  <- "/afs/crc.nd.edu/user/c/crollin1/ED_PalEON/MIP2_Region/1_spin_initial/phase2_spininit.v1/"
out.base <- "/afs/crc.nd.edu/user/c/crollin1/ED_PalEON/MIP2_Region/2_SAS/SAS_init_files.v1/"
