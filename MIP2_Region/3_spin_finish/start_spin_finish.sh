...
do
	...
	pushd ${file_path}
        ...
        sed -i "s/NL%IYEARZ   = .*/NL%IYEARA   = 1850/" ED2IN # Set first year
        sed -i "s/NL%IMONTHZ  = .*/NL%IMONTHA  = 01/" ED2IN # Set first month
        sed -i "s/NL%IDATEZ   = .*/NL%IDATEA   = 01/" ED2IN # Set first day
